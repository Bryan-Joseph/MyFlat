...
loginAdmin.addEventListener('click',() => {
    var assosAdminEmail = document.getElementById('assosownerEmailLogin').value;
    var assosAdminPass = document.getElementById('assosownerPassLogin').value;
    ...
    .then(()=> {
        ...
        swal({
            title: "Success",
            text: "Owner Successfully Loged In!",
            icon: "success",
        }).then(()=> {
